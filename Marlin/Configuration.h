...
#define STRING_CONFIG_H_AUTHOR "(Jordi Boehme Lopez)" // Who made the changes.
...
#define MACHINE_UUID "bad8d0e1-217e-4b3e-8224-12d3f612064e"
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // Tevo Black Widow - Jordi
  #define  DEFAULT_Kp 26.95
  #define  DEFAULT_Ki 2.35
  #define  DEFAULT_Kd 77.26

  // FIND YOUR OWN: "M303 E0 S200 C8" to run autotune on the head at 200 degreesC for 8 cycles.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 431}  // Tevo Black Widow with stock extruder and Trinamics driver
/**
